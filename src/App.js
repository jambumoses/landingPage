...
export default function App() {
  ...
  const webDescription = useSelector((state) => state.constant.webDescription);
  const webKeywords = useSelector((state) => state.constant.webKeywords);
  const webAuthor = useSelector((state) => state.constant.webAuthor);
  ...
  useEffect(() => {
    ...
    $("#web-description").attr("content",webDescription);
    $("#web-keywords").attr("content",webKeywords);
    $("#web-author").attr("content",webAuthor);
    ...
    <>
      <Router>
        ...
        {currentPage != "home" &&
          ...
          currentPage != "DashMessages" &&
          currentPage != "DashEmailListing" &&
          currentPage != "DashSettings" && <Footer />}
      </Router>
    </>
  );
}
